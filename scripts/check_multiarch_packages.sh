...
echo -e "   # Test x86_64:"
echo -e "   docker run --platform linux/amd64 cosmelab/diapause-rnaseq:master python -c \"import pandas; print('x86_64 works')\""
echo -e "   # Test ARM64:"
echo -e "   docker run --platform linux/arm64 cosmelab/diapause-rnaseq:master python -c \"import pandas; print('ARM64 works')\"" 