...
export CONTAINER_PATH="/bigdata/cosmelab/lcosme/docker/diapause-rnaseq.sif"
export BIND_PATHS="/bigdata/cosmelab/lcosme/docker:/proj"
export NXF_CONFIG="/bigdata/cosmelab/lcosme/docker/nf-core/configs/hpc_batch.conf"
